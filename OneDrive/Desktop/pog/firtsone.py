...
class SimpleStoreApp:
    ...
    def add_order(self, client):
        ...
        while True:
            ...
            try:
                price_str = simpledialog.askstring("Добавить товар", "Цена:")
                qty_str = simpledialog.askstring("Добавить товар", "Количество:")
